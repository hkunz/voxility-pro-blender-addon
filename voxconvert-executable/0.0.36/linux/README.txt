...
sudo dpkg -i vengi-shared_0.0.36.0-1_amd64.deb
sudo dpkg -i vengi-voxconvert_0.0.36.0-1_amd64.deb
...
[a@User]:/mnt/c/Users/harry/Downloads $ sudo dpkg -i vengi-shared_0.0.36.0-1_amd64.deb
Selecting previously unselected package vengi-shared.
(Reading database ... 33970 files and directories currently installed.)
Preparing to unpack vengi-shared_0.0.36.0-1_amd64.deb ...
Unpacking vengi-shared (0.0.36.0-1) ...
Setting up vengi-shared (0.0.36.0-1) ...
Processing triggers for shared-mime-info (2.1-2) ...
[a@User]:/mnt/c/Users/harry/Downloads $ sudo dpkg -i vengi-voxconvert_0.0.36.0-1_amd64.deb
Selecting previously unselected package vengi-voxconvert.
(Reading database ... 34024 files and directories currently installed.)
Preparing to unpack vengi-voxconvert_0.0.36.0-1_amd64.deb ...
Unpacking vengi-voxconvert (0.0.36.0-1) ...
