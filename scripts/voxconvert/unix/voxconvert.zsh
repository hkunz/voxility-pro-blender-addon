...
EXIT_CODE_SUCCESS=0
EXIT_CODE_ERROR_ROSETTA_NOT_INSTALLED=11
EXIT_CODE_ERROR_EXECUTING_VOXCONVERT=12
EXIT_CODE_ERROR_UNSUPPORTED_ARCH=12

# Function to get formatted arguments
get_formatted_args() {
    local command_str="$1"
...
#args=$(get_formatted_args "$command_str")
#echo -e "$command \n$args"
