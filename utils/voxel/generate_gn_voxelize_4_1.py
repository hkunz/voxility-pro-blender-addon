...
# ========================================================================================================== ### Manual Entry
    ...
    #initialize voxilityvoxelize nodes
    #voxilityvoxelize interface
    #Socket Geometry
...
# ========================================================================================================== ### Manual Entry
def voxelizemodifier_node_group_4_1(voxelize, node_group_name, min_value, max_value, default_value): ### Manual Entry
...
# ========================================================================================================== ### Manual Entry
    ...
    #initialize voxilityvoxelizemodifier nodes
    #voxilityvoxelizemodifier interface
    #Socket Geometry
    ...
    group_input_1.location = (561.7833862304688, -189.92282104492188)
    ...
    #initialize voxilityvoxelizemodifier links
...
def add_voxelizer_4_1(obj, min_value, max_value, default_value):
    voxelize = voxelize_node_group_4_1(NameConstant.VOXILITY_NODE_GROUP_NAME.value, min_value, max_value, default_value)
    voxelizemodifier = voxelizemodifier_node_group_4_1(voxelize, NameConstant.VOXILITY_MODIFIER_NAME.value, min_value, max_value, default_value)
