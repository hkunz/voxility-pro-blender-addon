...
# ========================================================================================================== ### Manual Entry
    ...
    #Value_Rotation
    sample_nearest_surface_002.inputs[6].default_value = (0.0, 0.0, 0.0)
    ...
    #Value_Rotation
    evaluate_on_domain_001.inputs[5].default_value = (0.0, 0.0, 0.0)
    ...
    #Value_005
    capture_attribute.inputs[6].default_value = (0.0, 0.0, 0.0)
    ...
    #Value_Rotation
    sample_nearest_surface.inputs[6].default_value = (0.0, 0.0, 0.0)
    ...
    #Value_Rotation
    sample_nearest_surface_001.inputs[6].default_value = (0.0, 0.0, 0.0)
    ...
    voxelize.links.new(vector_math_003.outputs[0], sample_nearest_surface_001.inputs[7])
    ...
    voxelize.links.new(vector_math_003.outputs[0], sample_nearest_surface.inputs[7])
    ...
    voxelize.links.new(vector_math_003.outputs[0], sample_nearest_surface_002.inputs[7])
    ...
    voxelize.links.new(evaluate_on_domain_001.outputs[3], store_named_attribute_001.inputs[3])
    #evaluate_on_domain_001.Value -> store_named_attribute_001.Value
    voxelize.links.new(evaluate_on_domain_001.outputs[3], store_named_attribute_001.inputs[5])
    #sample_nearest_surface_002.Value -> evaluate_on_domain_001.Value
