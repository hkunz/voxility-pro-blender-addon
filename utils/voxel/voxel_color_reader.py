...
from voxelity_pro.utils.color_utils import ColorUtils
from voxelity_pro.exceptions.color_read_error import ColorReadError
...
def test_read_voxel_colors_and_write_qb_file():
    ...
    if bpy.app.version >= (5, 2, 0):
        ...
        voxel_size_value = geometry_nodes_modifier["Socket_2"]
    else:
        voxel_size_value = geometry_nodes_modifier["Input_1"]
